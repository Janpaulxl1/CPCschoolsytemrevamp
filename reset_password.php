...
<head>
  ...
  <title>CPC Clinic - Reset Password</title>
  ...
  <script>
    ...
    function handleReset(e) {
      ...
      if (username.value.trim() === "" || oldPassword.value.trim() === "" || newPassword.value.trim() === "" || confirmPassword.value.trim() === "") {
        username.classList.add("shake");
        oldPassword.classList.add("shake");
        newPassword.classList.add("shake");
        confirmPassword.classList.add("shake");
        setTimeout(() => {
          username.classList.remove("shake");
          oldPassword.classList.remove("shake");
  ...
  <div class="main-wrapper">
    <div class="content">
      ...
      <div class="reset-card">
        ...
        <form action="reset_password_process.php" method="POST" onsubmit="handleReset(event)">
        ...
        <a href="index.html" class="text-center block mt-4 text-white underline">Back to Login</a>
      </div>
    </div>
  </div>
